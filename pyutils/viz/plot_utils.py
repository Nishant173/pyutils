...
def __reorder_timseries_data(
        x_vals: List[Union[int, float, str]],
...
def __plot_descriptive_stats(
        ...
        line_width: Optional[Union[int, float]] = 2,
    ):
    """
...
def plot_valuecounts(title: str,
                     array: List[Any],
...
def plot_timeseries(title: str,
                    ...
                    line_width: Optional[Union[int, float]] = 3,
